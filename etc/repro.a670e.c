...
{
  long res;
  memcpy((void*)0x20000780, "/dev/ptmx", 10);
  res = syscall(__NR_openat, 0xffffffffffffff9c, 0x20000780, 0, 0);
  if (res != -1)
    r[0] = res;
  memcpy((void*)0x20000140, "\x1a\x00\x00\x00\x00\x70\x0d\x00\x06\x00\x00\x00"
                            "\x00\x00\x08\x00\x36\xeb\x05\xff\x41\xdd\x54\x01"
                            "\x00\x33\x66\x95\xe8\x86",
         30);
